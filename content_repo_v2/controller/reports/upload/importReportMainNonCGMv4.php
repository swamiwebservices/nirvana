...
$importFailureEmailMessage = "<div>
    <p>There was an error importing the non_cmg_main_report_file_upload into Content Reporting on ".date("Y-m-d")." at ".date("h:m:s")."</p>
</div>";
$importSuccessEmailMessage = "<div>
    <p>There was NO error importing the non_cmg_main_report_file_upload into Content Reporting on ".date("Y-m-d")." at ".date("h:m:s")."</p>
</div>";
 $date1 = new DateTime();
...
if (!noError($conn)) {
    ...
    $logMsg = "non_cmg_main_report_file_upload background process start: ".date("Y-m-d h:i:s");
 ...
 */
    ...
    $emailSubject = "Import non_cmg_main_report_file_upload Report";
    ...
    $insertInfoArr = insert_non_cgm_main_reportv4($filePath, $tableName, $conn);
    ...
    if (!noError($insertInfoArr)) {
        ...
        $logMsg = "successfully imported csv into table. Run insert_non_cgm_main_report query for partner-provided: ".'_____'.date("h:m:s");
        ...
        $autoAssignChannelCOMap = autoAssignContentOwnernon_cgm_mainv4(
            $tableName,
            $conn
        );
