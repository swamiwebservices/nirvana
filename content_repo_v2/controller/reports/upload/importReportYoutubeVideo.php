...
$importFailureEmailMessage = "<div>
    <p>There was an error importing the Youtube Video Report Claim into Content Reporting on ".date("Y-m-d")." at ".date("h:m:s")."</p>
</div>";
$importSuccessEmailMessage = "<div>
    <p>There was NO error importing the Youtube Video Report Claim into Content Reporting on ".date("Y-m-d")." at ".date("h:m:s")."</p>
</div>";
$date1 = new DateTime();
...
if (!noError($conn)) {
    ...
    $emailSubject = "Import Youtube Video Report";
