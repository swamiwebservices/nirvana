...
$importFailureEmailMessage = "<div>
    <p>There was an error importing the Youtube Audio Report Claim into Content Reporting on ".date("Y-m-d")." at ".date("h:m:s")."</p>
</div>";
$importSuccessEmailMessage = "<div>
    <p>There was NO error importing the Youtube Audio Report Claim into Content Reporting on ".date("Y-m-d")." at ".date("h:m:s")."</p>
</div>";
$date1 = new DateTime();
...
if (!noError($conn)) {
    ...
    $logFileName="importYoutubeAudioBackground.json";

    $logMsg = "Import Youtube Video Report Claim background process start: ".date("Y-m-d h:i:s");
    ...
    $emailSubject = "Import Youtube Audio (Claim) Report";
    ...
    $insertInfoArr = insertReportVideoInfo($filePath, $tableName, $conn);
