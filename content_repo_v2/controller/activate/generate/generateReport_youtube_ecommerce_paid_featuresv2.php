...
if (!noError($conn)) {
    ...
    $emailSubject = "Generate Activate   youtube_red_music_video_finance_report ";
 ...
 */
   ...
   //youtube_ecommerce_paid_features
    $insertInfoArr = generateActication_youtube_ecommerce_paid_features_Reportv3($tableName,$actableName,$conn);
