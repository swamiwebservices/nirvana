...
if (!noError($conn)) {
    ...
    $logMsg = "Export Main_NON_CMG background process start: ".date("Y-m-d h:i:s");
    ...
    $emailSubject = "Generate Export Main_NON_CMG Report";
        ...
        $returnArr["errMsg"] = getErrMsg(5)." Error fetching clients details.";
         ...
         if ($export) {
            ...
            for($i=0;$i<$noofexcels;$i++){
                ...
                $allClientsInfo  = ExportClientReport_main_non_CMGv2($table_type_name, $conn,$offset,$resultsPerPage,$searchdata,$clientsession,$other_tables);
