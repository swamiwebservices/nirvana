...
//type_table
    ...
    $allClientsInfocount  = ExportClientsSaavanMusicReport_countv2($table_type_name ,$conn,$offset,$resultsPerPage,'',$clientsession,$other_tables);
    ...
    if (!noError($allClientsInfocount)) {
        ...
        $returnArr["errMsg"] = getErrMsg(5)." Error fetching clients details.";
         ...
         if ($export) {
            ...
            $xcelfiles = [];
            $headtitle = ['TrackName','ISRC','Language','Label','Ad-Supported Streams','Subscription Streams','Jio-Trial Streams','Total Streams','Ad Supported Revenue','Subscription Revenue','Total Revenue','Final Payables','GST','Final Payable-GST'];
            ...
            for($i=0;$i<$noofexcels;$i++){
                ...
                $allClientsInfo  = ExportClientsSaavanMusicReportv2($table_type_name, $conn,$offset,$resultsPerPage,$searchdata,$clientsession,$other_tables);
