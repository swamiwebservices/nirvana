...
if (!noError($conn)) {
    ...
    //get data from finanace report 
         ...
         $limit =  isset($_GET['length']) ? $_GET['length'] :'500';  

          $table_type_name = "youtube_red_music_video_finance_report_".$type_table."%_".$year."_".$month;
        $clientInfo = getyoutube_red_music_video_finance_reportv3($table_type_name,$conn,$offset,$limit,$searchdata,$_SESSION['client']);  
      //  print_r($clientInfo);
