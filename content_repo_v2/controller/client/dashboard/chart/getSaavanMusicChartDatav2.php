...
{ 
    ...
    $chartInfo  = RevenueChartClientsSaavanMusicReportv2($table_type_name,$conn,$offset,$resultsPerPage,'',$clientsession,$channelid );
   ...
   // print_r($chartInfo);
    ...
    $chartInfo  = ViewsChartClientsSaavanMusicReportv2($table_type_name,$conn,$offset,$resultsPerPage,'',$clientsession,$channelid);
    //print_r($chartInfo);
    if (!noError($chartInfo)) {
