...
{ 
    ...
    $finance_report_table = 'youtube_red_music_video_finance_report_nd1_'.$year.'_'.$month;
    $youtube_report_table = 'youtube_red_music_video_finance_report_nd1_'.$year.'_'.$month;

    $allchart=[];
    $table_type_name = "youtube_red_music_video_finance_report_".$type_table."%_".$year."_".$month;
    $chartInfo  = RevenueChartClientsYoutubeFinanceReportv2($table_type_name, $youtube_report_table ,$conn,$offset,$resultsPerPage,'',$clientsession,$channelid );
    ...
    $chartInfo  = ViewsChartClientsYoutubeFinanceReportv2($table_type_name, $youtube_report_table ,$conn,$offset,$resultsPerPage,'',$clientsession,$channelid);
    if (!noError($chartInfo)) {
