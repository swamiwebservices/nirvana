...
{ 
    ...
    $chartInfo  = RevenueChartClientsItuneMusicReportv2($table_type_name,$conn,$offset,$resultsPerPage,'',$clientsession,$channelid );
   ...
   // print_r($chartInfo);
    ...
    $chartInfo  = ViewsChartClientsItuneMusicReportv2($table_type_name,$conn,$offset,$resultsPerPage,'',$clientsession,$channelid);
    //print_r($chartInfo);
    if (!noError($chartInfo)) {
