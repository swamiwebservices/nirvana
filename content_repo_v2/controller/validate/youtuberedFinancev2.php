...
$table = 'youtube_red_music_video_finance_report_'.$nd.'_'.$year.'_'.$month; ;
...
if(!empty($_GET['report']) && $_GET['report']=='youtube_red_music_video_finance_report'){
    if($nd=="redmusic"){
 
        $columns = array(
            array( 'db' => 'id',  'dt' => 0 ),
            array( 'db' => 'videoID',  'dt' => 1 ),	
            array( 'db' => 'contentType',  'dt' => 2 ),	
            array( 'db' => 'asset_labels',  'dt' => 3 ),	
           
            array( 'db' => 'content_owner',  'dt' => 4 ),
            array( 'db' => 'partnerRevenue',  'dt' => 5 ),
            array( 'db' => 'assetID',  'dt' => 6 ),
            array( 'db' => 'datefrom',  'dt' => 7 ),	
        );
    }    else {
