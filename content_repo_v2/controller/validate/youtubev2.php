...
$table = 'youtube_video_claim_report_'.$nd.'_'.$year.'_'.$month; ;
...
if(!empty($_GET['report']) && $_GET['report']=='youtube_video_claim_report_nd'){   
    $columns = array(
        array( 'db' => 'id',  'dt' => 0 ),
        array( 'db' => 'videoID',  'dt' => 1 ),	
        array( 'db' => 'assetID',  'dt' => 2 ),	
        array( 'db' => 'assetChannelID',  'dt' => 3 ),	
        array( 'db' => 'contentType',  'dt' => 4 ),
        array( 'db' => 'Label',  'dt' => 5 ),
        array( 'db' => 'partnerRevenue',  'dt' => 6 ),
