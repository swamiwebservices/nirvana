...
if (!noError($conn)) {
   ...
   // $youtube_report_table = 'youtube_video_claim_report_'.$year.'_'.$month;
    ...
    $allClientsInfocount  = ExportClientsYoutubeRedMusicUnAssignedv2($youtube_report_table, $conn,$offset,$resultsPerPage,'',$youtube_report_table);
        ...
        $returnArr["errMsg"] = getErrMsg(5)." Error fetching clients details.";
         ...
         if ($export) {
            ...
            for($i=0;$i<$noofexcels;$i++){
                ...
                $allClientsInfo  = ExportClientsYoutubeFinanceReportv2($finance_report_table, $youtube_report_table ,$conn,$offset,$resultsPerPage,$searchdata,$youtube_report_table);
