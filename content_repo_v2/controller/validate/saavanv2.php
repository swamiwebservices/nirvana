...
$table = 'report_audio_'.$nd.'_'.$year.'_'.$month; ;
...
if (!noError($conn)) {
    ...
    $conn = $conn["errMsg"];
    $returnArr = array();
	$contentowner_rs = getContentOwner($conn);
    $contentowner= $contentowner_rs['errMsg'];
...
if(!empty($_GET['report']) && $_GET['report']=='saavanmusic'){   
    $columns = array(
        array( 'db' => 'id',  'dt' => 0 ),
        array( 'db' => 'TrackName',  'dt' => 1 ),	
        array( 'db' => 'ISRC',  'dt' => 2 ),	
        array( 'db' => 'Label',  'dt' => 3 ),
        array( 'db' => 'Ad_Supported_Streams',  'dt' => 4 ),
        array( 'db' => 'Ad_Supported_Revenue',  'dt' => 5 ),
        array( 'db' => 'Subscription_Streams',  'dt' => 6 ),
        array( 'db' => 'Subscription_Revenue',  'dt' => 7 ),
        array( 'db' => 'Total_Streams',  'dt' => 8 ),
        array( 'db' => 'Total_Revenue',  'dt' => 9 ),
        array( 'db' => 'content_owner',  'dt' => 10 ),
...
require( 'applemusicv2.ssp.class.php' );
