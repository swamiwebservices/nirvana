...
if (!noError($conn)) {
    ...
    $paramlog['file_name'] = '';
    $paramlog['status_name'] = "Export Revenue-start";
    ...
    $backgroundOutput = runBackgroundProcess("{$controller} {$selectedDate} {$paramlog['table_name']} {$type_cate} {$nd} {$onlyunassigned} {$contentOwner}");
