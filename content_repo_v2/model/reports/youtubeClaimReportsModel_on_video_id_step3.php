...
// now update on video id
    ...
    @unlink("polo33.txt");
    file_put_contents("polo33.txt", $autoAssignChannelCOMapQuery);
    @chmod("polo33.txt", 0777);
   ...
   @unlink("pp2.txt");
   file_put_contents("pp2.txt", $autoAssignChannelCOMapQuery);
   @chmod("pp2.txt", 0777);
...
@unlink("polo3333.txt");
file_put_contents("polo3333.txt", $autoAssignChannelCOMapQuery);
@chmod("polo3333.txt", 0777);
