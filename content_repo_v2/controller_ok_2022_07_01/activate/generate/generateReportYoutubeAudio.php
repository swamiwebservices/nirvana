...
$importFailureEmailMessage = "<div>
    <p>There was an error Activation genrating the Youtube Audio Report into Content Reporting on ".date("Y-m-d")." at ".date("h:m:s")."</p>
</div>";
$importSuccessEmailMessage = "<div>
    <p>There was NO error Activation genrating the Youtube Audio Report into Content Reporting on ".date("Y-m-d")." at ".date("h:m:s")."</p>
</div>";
$date1 = new DateTime();
...
if (!noError($conn)) {
    ...
    //get the user info
    $email = "importYoutubeAudioReport@background.process";
    ...
    $emailSubject = "Generate Activate Youtube Audio Report";
    ...
    $insertInfoArr = generateAudioActicationReport($tableName,$actableName,$conn);
