...
$importFailureEmailMessage = "<div>
    <p>There was an error Activation genrating the gaana music Report into Content Reporting on ".date("Y-m-d")." at ".date("h:m:s")."</p>
</div>";
$importSuccessEmailMessage = "<div>
    <p>There was NO error Activation genrating the gaana music Report into Content Reporting on ".date("Y-m-d")." at ".date("h:m:s")."</p>
</div>";
$date1 = new DateTime();
...
if (!noError($conn)) {
    ...
    $emailSubject = "Generate Activate gaana music Report";
 ...
 */
    ...
    $insertInfoArr = generateActicationSaavanMusic_report_Tablev3($tableName,$actableName,$conn);
