...
$importFailureEmailMessage = "<div>
    <p>There was an error Activation genrating the Amazon Video Report   into Content Reporting on ".date("Y-m-d")." at ".date("h:m:s")."</p>
</div>";
$importSuccessEmailMessage = "<div>
    <p>There was NO error Activation genrating the Amazon Video Report   into Content Reporting on ".date("Y-m-d")." at ".date("h:m:s")."</p>
</div>";
$date1 = new DateTime();
...
if (!noError($conn)) {
    ...
    $logMsg = "Activate Amazon Video background process start: ".date("Y-m-d h:i:s");
    ...
    $emailSubject = "Generate Activate Amazon Video Report  ";
    ...
    $insertInfoArr = generateActicationReportAmazon($tableName,$actableName,$conn);
