...
$table = 'youtube_ecommerce_paid_features_report_'.$nd.'_'.$year.'_'.$month; ;
...
if(!empty($_GET['report']) && $_GET['report']=='youtube_ecommerce_paid_features_report'){   
    $columns = array(
        array( 'db' => 'id',  'dt' => 0 ),
        array( 'db' => 'purchase_type',  'dt' => 1 ),	
        array( 'db' => 'channel_name',  'dt' => 2 ),	
        array( 'db' => 'channel_id',  'dt' => 3 ),	
        array( 'db' => 'video_id',  'dt' => 4 ),
        array( 'db' => 'earnings',  'dt' => 5 ),
        array( 'db' => 'content_owner',  'dt' => 6 ),
        array( 'db' => 'Label',  'dt' => 7 ),
