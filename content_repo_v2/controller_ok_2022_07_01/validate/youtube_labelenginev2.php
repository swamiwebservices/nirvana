...
$table = 'youtube_labelengine_report_'.$nd.'_'.$year.'_'.$month; ;
...
if(!empty($_GET['report']) && $_GET['report']=='youtube_labelengine_report'){   
    $columns = array(
        array( 'db' => 'id',  'dt' => 0 ),
        array( 'db' => 'contentType',  'dt' => 1 ),	
        array( 'db' => 'assetID',  'dt' => 2 ),
        array( 'db' => 'partnerRevenue',  'dt' => 3 ),
