...
$importFailureEmailMessage = "<div>
    <p>There was an error importing the Youtube Red Finance Report v2 into Content Reporting on ".date("Y-m-d")." at ".date("h:m:s")."</p>
</div>";
$importSuccessEmailMessage = "<div>
    <p>There was NO error importing the Youtube Red Finance Report v2 into Content Reporting on ".date("Y-m-d")." at ".date("h:m:s")."</p>
</div>";
$date1 = new DateTime();
...
if (!noError($conn)) {
    ...
    $logMsg = "Import Youtube Red Finance Report v2 background process start: ".date("Y-m-d h:i:s");
    ...
    $emailSubject = "Import Red Finance Report v2";
    ...
    $insertInfoArr = insert_youtube_ecommerce_paid_featuresv2($filePath, $tableName, $conn);
    ...
    if (!noError($insertInfoArr)) {
       ...
       $autoAssignChannelCOMap = autoAssignChannelCOMap_youtube_ecommerce_paid_featuresv2(
            $tableName,
