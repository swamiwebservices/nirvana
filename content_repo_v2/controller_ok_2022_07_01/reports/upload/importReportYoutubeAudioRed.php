...
$importFailureEmailMessage = "<div>
    <p>There was an error importing the Youtube Audio red Report into Content Reporting on ".date("Y-m-d")." at ".date("h:m:s")."</p>
</div>";
$importSuccessEmailMessage = "<div>
    <p>There was NO error importing the Youtube Audio red Report into Content Reporting on ".date("Y-m-d")." at ".date("h:m:s")."</p>
</div>";
$date1 = new DateTime();
...
if (!noError($conn)) {
    ...
    //get the user info
    $email = "importYoutubeAudioRedReport@background.process";
    ...
    $emailSubject = "Import Youtube Audio Red";
    ...
    $insertInfoArr = insertYTAudioRedReportInfo($filePath, $tableName, $conn);
    ...
    if (!noError($insertInfoArr)) {
        ...
        $autoAssignChannelCOMap = autoAssignChannelCOMapforYTAudioRed(
            $tableName,
            $fieldSearchArr,
            $contentType,
            $conn
