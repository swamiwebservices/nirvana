...
$importFailureEmailMessage = "<div>
    <p>There was an error importing the Youtube US Report v2 into Content Reporting on ".date("Y-m-d")." at ".date("h:m:s")."</p>
</div>";
$importSuccessEmailMessage = "<div>
    <p>There was NO error importing the Youtube US Report v2 into Content Reporting on ".date("Y-m-d")." at ".date("h:m:s")."</p>
</div>";
$date1 = new DateTime();
...
if (!noError($conn)) {
    ...
    $logMsg = "Import Youtube US Report v2 background process start: ".date("Y-m-d h:i:s");
    ...
    $emailSubject = "Import US Report v2";
    ...
    $insertInfoArr = insert_youtube_labelenginev2($filePath, $tableName, $conn);
    ...
    if (!noError($insertInfoArr)) {
       ...
       $autoAssignChannelCOMap = autoAssign_labelenginev2(
            $tableName,
