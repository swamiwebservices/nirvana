...
{ 
    ...
    $chartInfo  = RevenueChartClientsAmazonReport($finance_report_table, $youtube_report_table ,$conn,$offset,$resultsPerPage,'',$clientsession,$channelid );
    ...
    if (!noError($chartInfo)) {
        ...
        $allchart['revenue']=$chartInfo;
        
    }
    $chartInfo  = ViewsChartClientsAmazonReport($finance_report_table, $youtube_report_table ,$conn,$offset,$resultsPerPage,'',$clientsession,$channelid);
    if (!noError($chartInfo)) {
