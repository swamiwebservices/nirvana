...
{ 
    ...
    $chartInfo  = RevenueChartClientsGaanaMusicReportv2($table_type_name,$conn,$offset,$resultsPerPage,'',$clientsession,$channelid );
   ...
   // print_r($chartInfo);
    ...
    if (!noError($chartInfo)) {
        ...
        $returnArr["errMsg"] = getErrMsg(5)." Error fetching clients details.";
         ...
         $revchart['cols']=[
                ...
                ['label'=>'Sub_vendor_Name','type'=>'string'],
    ...
    $chartInfo  = ViewsChartClientsGaanaMusicReportv2($table_type_name,$conn,$offset,$resultsPerPage,'',$clientsession,$channelid);
    //print_r($chartInfo);
    if (!noError($chartInfo)) {
