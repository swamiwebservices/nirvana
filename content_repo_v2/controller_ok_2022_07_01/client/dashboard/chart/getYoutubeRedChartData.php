...
{ 
    ...
    $chartInfo  = RevenueChartClientsYoutubeRedFinanceReport($finance_report_table, $youtube_report_table ,$conn,$offset,$resultsPerPage,'',$clientsession,$channelid );
    ...
    $chartInfo  = ViewsChartClientsYoutubeRedFinanceReport($finance_report_table, $youtube_report_table ,$conn,$offset,$resultsPerPage,'',$clientsession,$channelid);
    if (!noError($chartInfo)) {
