...
{ 
    ...
    $finance_report_table = 'youtube_ecommerce_paid_features_report_nd1_'.$year.'_'.$month;
    $youtube_report_table = 'youtube_ecommerce_paid_features_report_nd1_'.$year.'_'.$month;

    $allchart=[];
    $table_type_name  = 'youtube_ecommerce_paid_features_report_'.$type_table.'%'.$year.'_'.$month;
    $chartInfo  = RevenueChartyoutube_ecompaidfeaturesv2($table_type_name, $youtube_report_table ,$conn,$offset,$resultsPerPage,'',$clientsession,$channelid );
    ...
    $chartInfo  = ViewsChartyoutube_ecompaidfeaturesv2($table_type_name, $youtube_report_table ,$conn,$offset,$resultsPerPage,'',$clientsession,$channelid);
    if (!noError($chartInfo)) {
