...
if (!noError($conn)) {
    ...
    if(file_exists('../../../../excelreports/'.$clientsession."_youtuberedmusic_".$year.'_'.$month.'.zip')){
        unlink('../../../../excelreports/'.$clientsession."_youtuberedmusic_".$year.'_'.$month.'.zip');
    }
    ...
    $allClientsInfocount  = ExportClientsYoutubeRedMusicReport_countv3($table_type_name ,$conn,$offset,$resultsPerPage,'',$clientsession,$other_tables);
    ...
    if (!noError($allClientsInfocount)) {
        ...
        $returnArr["errMsg"] = getErrMsg(5)." Error fetching clients details.";
         ...
         if ($export) {
            ...
            $xcelfiles = [];
            $headtitle = ['Channel-Name','Content-Type','Label','Record-Label','asset_title','Channel-id','Video Id','Video title','ISRC','UPC','GRid','AssetId','assetChannelID','Youtube payout','RevShare','USPAYOUT','Holding-Perc','WITHHOLDING','Final Payable','GST','Final Payable-with'];
            ...
            for($i=0;$i<$noofexcels;$i++){
                ...
                $allClientsInfo  = ExportClientsYoutubeRedMusicReportv3($table_type_name, $conn,$offset,$resultsPerPage,$searchdata,$clientsession,$other_tables);
            ...
            $zip_file_tmp='../../../../excelreports/'.$clientsession."_youtuberedmusic_".$year.'_'.$month.'.zip';
            $zip = new ZipArchive();
    ...
    if(isset($argv[4])){
        ...
        //end 
         ...
         $emailMessage.='<br><a href="'.$rootUrl."excelreports/".$clientsession."_youtuberedmusic_".$year.'_'.$month.'.zip'.'">Click to Download </a>';
