...
if (!noError($conn)) {
    ...
    if(file_exists('../../../../'.$clientsession."_Youtube_dashboard_".$year.'_'.$month.'.zip')){
        unlink('../../../../'.$clientsession."_Youtube_dashboard_".$year.'_'.$month.'.zip');
    }
    ...
    $allClientsInfocount  = ExportClientsYoutubeFinanceReport($finance_report_table, $youtube_report_table ,$conn,$offset,$resultsPerPage,'',$clientsession);
        ...
        $returnArr["errMsg"] = getErrMsg(5)." Error fetching clients details.";
         ...
         if ($export) {
            ...
            for($i=0;$i<$noofexcels;$i++){
                ...
                $allClientsInfo  = ExportClientsYoutubeFinanceReport($finance_report_table, $youtube_report_table ,$conn,$offset,$resultsPerPage,$searchdata,$clientsession);
            ...
            $zip_file_tmp='../../../../'.$clientsession."_Youtube_dashboard_".$year.'_'.$month.'.zip';
            $zip = new ZipArchive();
