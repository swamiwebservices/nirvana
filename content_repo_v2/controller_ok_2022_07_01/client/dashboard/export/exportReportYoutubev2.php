...
//print_r($argv);
    ...
    if (file_exists('../../../../excelreports/' . $clientsession."_Youtube_Client_data_" . $year . '_' . $month . '.zip')) {
        $zip_file_tmp = '../../../../excelreports/' . $clientsession."_Youtube_Client_data_" . $year . '_' . $month . '.zip';
    }
    ...
    try {
        ...
        if (isset($argv[4])) {
            $zip_file_name =  $clientsession."_YoutubeClaim_report_" . $year . "_" . $month . ".zip";
            $process_id = $argv[4];
        ...
        $allClientsInfocount = ExportClientsYoutubeClaimReportCountv3($table_type_name, $conn, $offset, $resultsPerPage, '', $clientsession);
        ...
        if (!noError($allClientsInfocount)) {
            ...
            if ($export) {
                ...
                for ($i = 0; $i < $noofexcels; $i++) {
                    ...
                    $allClientsInfo = ExportClientsYoutubeClaimReportv3($table_type_name, $conn, $offset, $resultsPerPage, $searchdata, $clientsession,$other_tables);
                ...
                $zip_file_tmp = "../../../../excelreports/".$clientsession."_YoutubeClaim_report_" . $year . '_' . $month . '.zip';
                $zip = new ZipArchive();
        ...
        $emailMessage .= '<br><a href="' . $rootUrl . "excelreports/".$clientsession."_Youtube_dashboard_" . $year . '_' . $month . '.zip' . '">Click to Download </a>';
