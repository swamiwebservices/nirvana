...
//type_table
    ...
    $allClientsInfocount  = ExportClientsSpotifyMusicReport_countv2($table_type_name ,$conn,$offset,$resultsPerPage,'',$clientsession,$other_tables);
    ...
    if (!noError($allClientsInfocount)) {
        ...
        $returnArr["errMsg"] = getErrMsg(5)." Error fetching clients details.";
         ...
         if ($export) {
            ...
            $xcelfiles = [];
            $headtitle = ['Country','Product','URI','UPC','EAN','ISRC','Track_name','Artist_name','Composer_name','Album_name','Quantity','Label','Payable_USD','GST','Final Payable-GST'];
            ...
            for($i=0;$i<$noofexcels;$i++){
                ...
                $allClientsInfo  = ExportClientsSpotifyMusicReportv2($table_type_name, $conn,$offset,$resultsPerPage,$searchdata,$clientsession,$other_tables);
