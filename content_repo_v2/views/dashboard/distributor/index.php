    ...
    if (!noError($userInfo)) {
        ...
        if (empty($userInfo)) {
            ...
            if ($userInfo[$email]["status"]!=1) {
                ...
                $fieldsStr = "distributor_id, distributor_name, email, status";
                $allDistributors = getDistributorsInfo($distributorSearchArr, $fieldsStr, null, $conn);
                if (empty($allDistributors["errMsg"])) {
                    //user not found
                    ...
                    $user = $allDistributors['errMsg'][$email];

                    //set the search array based on get parameters
                    $clientSearchArr = array();
                    $clientSearchArr["source"] = $user["distributor_id"];
...
<head>
    <meta charset="utf-8" />
    <link rel="icon" type="image/png" href="<?php echo $rootUrl; ?>assets/img/logo.png" />
                                ...
                                <div class="card-header">
                                    ...
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">
                                            <a href="<?php echo $rootUrl; ?>views/dashboard/distributor/index.php">
                                                <i class="fa fa-users">&nbsp;</i>Distributor Dashboard
                                            </a>
                                        </li>
                                    </ol>
                                </div> <!-- end card header -->
                                    ...
                                    <div class="col-md-12">
                                        <form enctype="multipart/form-data" class="form-inline searchForm" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="GET">
                                            ...
                                            <div class="form-group">
                                                ...
                                                $clientsSearchArr = array("source"=>$distributorID);
                                                $fieldsStr = "email, client_username, client_firstname, source, status";
