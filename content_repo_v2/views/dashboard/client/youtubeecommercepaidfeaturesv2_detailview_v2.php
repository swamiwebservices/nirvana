...
if (!noError($conn)) {
    ...
    if (!noError($clientInfo)) {
        ...
        $activatetableName  = 'youtube_ecom_paid_features_activation_report_'.$type_table.'%'.$year.'_'.$month;
    ...
    <div class="header" id="youtube1">
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <h4 class="modal2-title">youtube ecommerce paid features v2</h4>
...
$(document).ready(function() {
    ...
    var jsonData = $.ajax({
        url: "../../../controller/client/dashboard/chart/getyoutubeecommercepaidfeaturesv2.php",
        dataType: "json",
        data: {
    ...
    ///end chart code
        ...
        var table = $('#example').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "../../../controller/client/dashboard/youtubeecommercepaidfeaturesv2.php",
                "data": function(d) {
                    return $.extend({}, d, {
