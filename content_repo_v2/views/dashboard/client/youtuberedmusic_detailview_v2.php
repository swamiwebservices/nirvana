...
if (!noError($conn)) {
    ...
    if (!noError($clientInfo)) {
        ...
        $activatetableName  = 'youtube_redmusic_activation_report_redmusic_'.$year.'_'.$month;
...
//die();
    ...
    $youtube_report_table = 'youtuberedmusic_video_report_redmusic_' . $year . '_' . $month;
     $table_type_name = "youtuberedmusic_video_report_redmusic_". $year . '_' . $month;
    //get current client
    ...
    <div class="header" id="youtube1">
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <h4 class="modal2-title">Youtube Music</h4>
