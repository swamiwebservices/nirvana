    ...
    <div class="header" id="youtube1">
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <h4 class="modal2-title"><?php echo $type_table?> Music</h4>
...
?>
    ...
    <div class="col-md-2">
        <a href="applemusic_detailview_v2.php?type_table=<?php echo $type_table?>&userName=<?php echo $userName?>&reportMonthYear=<?php echo $_GET["reportMonthYear"]?>"
