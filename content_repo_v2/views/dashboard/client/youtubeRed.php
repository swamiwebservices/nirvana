...
if (!noError($conn)) {
    ...
    $email = $_SESSION['userEmail'];
     ...
     if (!noError($clientInfo)) {
        ...
        $allfantable = getAvilableActivateReports('youtube_activation_red', $clientname ,$conn);
    ...
    $getchennels = getChannelsofthereport($finance_report_table, $conn ,'', $_SESSION['client']);
    ...
    $getallchennels = $getchennels['errMsg']; 
                ...
                if (isset($_GET["export"])) {
                     ...
                     $allClientsInfocount = getClientsYoutubeFinanceReportCount($finance_report_table, $youtube_report_table ,$conn);
                      ...
                      if (!noError($allClientsInfocount)) {
                        ...
                        $returnArr["errMsg"] = getErrMsg(5)." Error fetching clients details.";
                         ...
                         if ($export) {
                            ...
                            ob_clean();ob_flush();
                            $xcelfiles = [];
                            $headtitle = ['Video title','Channel name','Youtube payout','Final Payable'];
                            ...
                            for($i=0;$i<$noofexcels;$i++){
                                ...
                                $allClientsInfo  = getClientsYoutubeFinanceReport($finance_report_table, $youtube_report_table ,$conn,$offset,$resultsPerPage,$searchdata);
                                $allClientsInfo = $allClientsInfo["errMsg"];
                                ...
                                // //download the file
                                $filename = "Youtube_Red_Client_data_".$year.'_'.$month.'_'.$i;
                                $xcelfiles[]=$filename;
                            ...
                            $download_filename = 'Client_Dashboard_Red_Youtube_'.$year.'_'.$month.'.zip'; 
...
<body>
    ...
    <div class="header" id="youtube1">
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <h4 class="modal2-title">Youtube Red</h4>
    ...
    <div class="col-md-12">
        ...
        <?php
        $fileis= $_SESSION['client'].'_Youtube_Red_dashboard_'.$year.'_'.$month.'.zip';
  ...
  ?>
    <div class="col-md-12">
        <div class="alert alert-default">
            <h5>Witholding amount : <?=$activationdata['us_payout']?> x 30% = <?=$activationdata['witholding']?> </h5>
            <h5>(<?=$activationdata['total_amt_recd'].'-'.$activationdata['witholding']?>) x
                <?=$activationdata['shares']?> % = <?=$activationdata['final_payable']?> </h5>
        </div>
    </div>
...
$(document).ready(function() {
    ...
    var jsonData = $.ajax({
        url: "../../../controller/client/dashboard/chart/getYoutubeRedChartData.php",
        dataType: "json",
        data: {
    ...
    var table = $('#example').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": "../../../controller/client/dashboard/youtubeRed.php",
            "data": function(d) {
                return $.extend({}, d, {
    ...
    $('#export').on('click', function(e) {
        $.ajax({
            ...
            data: {
                selected_date: '<?php echo $_GET["reportMonthYear"];?> ',
                type: 'youtube_red_report_co_dashboard'
            },
