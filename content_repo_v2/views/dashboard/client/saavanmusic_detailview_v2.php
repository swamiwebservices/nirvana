   ...
   <table id="example" class="table table-striped table-hover" style="width:100%">
        <thead>
            <tr>
                ...
                <th>Jio-Trial Streams</th>
                <th>Total Streams</th>
                <th>Ad upported Revenue</th>
...
$(document).ready(function() {
    ...
    var jsonData = $.ajax({
        url: "../../../controller/client/dashboard/chart/getSaavanMusicChartDatav2.php",
        dataType: "json",
        data: {
    ...
    ///end chart code
        ...
        var table = $('#example').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "../../../controller/client/dashboard/saavanmusic_v2.php",
                "data": function(d) {
                    return $.extend({}, d, {
