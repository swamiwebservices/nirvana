                      ...
                      if (!noError($allClientsInfocount)) {
                        ...
                        $returnArr["errMsg"] = getErrMsg(5)." Error fetching clients details.";
                         ...
                         if ($export) {
                            ...
                            $download_filename = 'Client_Dashboard_Youtube_'.$year.'_'.$month.'.zip'; 
...
<body>
    ...
    <div class="header" id="youtube1">
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <h4 class="modal2-title">Youtube Finance</h4>
    ...
    <div class="col-md-12">
        ...
        <?php
        $fileis= $_SESSION['client'].'_Youtube_dashboard_'.$year.'_'.$month.'.zip';
  ...
  ?>
    <table id="example" class="table table-striped table-hover" style="width:100%">
        ...
        <tfoot>
            <th>&nbsp;</th>
            <th>&nbsp;</th>
            <th>Total Youtube Payout : <?=$activationdata['total_amt_recd']?> USD</th>
            <th>Final Payable : <?=$activationdata['amt_payable']?> USD</th>
        </tfoot>
...
$(document).ready(function() {
    ...
    var table = $('#example').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": "../../../controller/client/dashboard/youtube.php",
            "data": function(d) {
                return $.extend({}, d, {
    ...
    $('#export').on('click', function(e) {
        $.ajax({
            ...
            data: {
                selected_date: '<?php echo $_GET["reportMonthYear"];?> ',
                type: 'youtube_finance_report_co_dashboard'
            },
