...
if (!noError($conn)) {
    ...
    if (!noError($clientInfo)) {
        ...
        $table_type_name = 'youtube_redmusic_activation_report_redmusic_' . $year . '_' . $month;
...
?>
    ...
    <div class="header" id="youtube1">
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <h4 class="modal2-title">Youtube Music <?php echo htmlspecialchars($_GET['reportMonthYear']); ?></h4>
    ...
    <div class="col-md-4">
        ...
        $fileis = $_SESSION['client'] . '_youtuberedmusic_' . $year . '_' . $month . '.zip';
...
?>
    ...
    <div class="col-md-4">
        ...
        $fileis = $_SESSION['client'] . '_youtuberedmusic_' . $year . '_' . $month . 'withholding.zip';
        if (file_exists('../../../excelreports/' . $fileis)) {
            ?>
        <a href='../../../excelreports/<?=$fileis?>'><button type="button" name="btnDownload" id="btnDownload"
    ...
    <div class="col-md-2">
        <a href="youtuberedmusic_detailview_v2.php?userName=<?php echo $userName?>&type_table=<?php echo $type_table?>&reportMonthYear=<?php echo $_GET["reportMonthYear"]?>"
...
$table_type_name_us_report = 'youtube_labelengine_activation_report_redmusic_' . $year . '_' . $month;
...
if (!noError($allClientsInfo_us_report)) {
  ...
  $allClientsInfo0  = ExportClientsYoutubeRedMusicReport_countv3($table_type_name ,$conn,$offset,$resultsPerPage,'',$clientsession,$other_tables,$downlaodType);
