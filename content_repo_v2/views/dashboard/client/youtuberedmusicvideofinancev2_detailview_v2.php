...
if (!noError($conn)) {
    ...
    if (!noError($clientInfo)) {
        ...
        $activatetableName  = 'youtube_red_music_finance_activation_report_'.$type_table.'%'.$year.'_'.$month;
...
$(document).ready(function() {
    ...
    var jsonData = $.ajax({
        url: "../../../controller/client/dashboard/chart/getyoutuberedmusicvideofinancev2.php",
        dataType: "json",
        data: {
    ...
    ///end chart code
        ...
        var table = $('#example').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "../../../controller/client/dashboard/youtuberedmusicvideofinancev2.php",
                "data": function(d) {
                    return $.extend({}, d, {
