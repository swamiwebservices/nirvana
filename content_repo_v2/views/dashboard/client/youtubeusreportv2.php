...
if (!noError($conn)) {
    ...
    $type_table = (isset($_GET['type_table'])) ? $_GET['type_table'] : '';
    ...
    if (!noError($clientInfo)) {
        ...
        $table_type_name = 'youtube_labelengine_activation_report_'.$type_table.'%_' . $year . '_' . $month;
...
?>
    ...
    <div class="header" id="youtube1">
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <h4 class="modal2-title">Youtube US Report  <?php echo htmlspecialchars($_GET['reportMonthYear']); ?></h4>
    ...
    <div class="col-md-4">
        ...
        <?php }  else {
//erikllpugc_youtubusreport_2021_08.zip

        $fileis = $_SESSION['client'] . '_youtubusreport_'. $type_table.'_' . $year . '_' . $month . '.zip';
...
?>
    ...
    <!-- <div class="col-md-2">
        <a href="youtubev2_detailview_v2.php?userName=<?php echo $userName?>&reportMonthYear=<?php echo $_GET["reportMonthYear"]?>"
...
-->
        ...
        $final_payable_us_with_gst = (isset($activationdata_us_report['final_payable_with_gst'])) ? $activationdata_us_report['final_payable_with_gst'] : 0   ;
                ...
                <?php
                    ...
                    $grand_final_payable_with_gst =  $final_payable_us_with_gst;
