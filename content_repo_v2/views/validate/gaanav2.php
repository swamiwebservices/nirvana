    ...
    <div class="header" id="youtube1">
        ...
        <div class="row">
            ...
            <div class="col-lg-5">
                ...
                <h4 class="modal2-title">Validate Report   Gaana Music <?php echo $nd?> <?php echo $selectedDate?></h4>
                ...
                <fieldset id="div2" class="alert alert-danger">
                    <div>
                        ...
                        <form method="post" name="frmassigncontentowner" id="frmassigncontentowner"
                            ...
                            <div>
                            * Update will be on the basis of   (gaana: Sub_vendor_Name) </br>
...
$(document).ready(function() {
    ...
    var table = $('#example').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": "../../controller/validate/gaanav2.php",
            "data": function(d) {
                return $.extend({}, d, {
