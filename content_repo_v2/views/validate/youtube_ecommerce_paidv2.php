...
if (!noError($conn)) {
   ...
   $month    = date("m", strtotime($selectedDate));
     $table_name = 'youtube_ecommerce_paid_features_report_'.$nd.'_'.$year.'_'.$month; ;
  ...
  $type = "youtube_ecommerce_paid_features";
?>
<!doctype html>
<html lang="en">
    ...
    <div class="header" id="youtube1">
        ...
        <div class="row">
            ...
            <div class="col-lg-11">
                ...
                <h4 class="modal2-title">Validate Report Youtube Ecommerce Paid Features  v2 <?php echo $nd?></h4>
                ...
                <fieldset id="div2" class="alert alert-danger">
                    <div>
                        ...
                        <form method="post" name="frmassigncontentowner" id="frmassigncontentowner"
                            ...
                            <div>
                            * Update will be on the basis of (Youtube: Asset-id), </br>
    ...
    <table id="example" class="table table-striped table-hover" style="width:100%">
        <thead>
            <tr>
                ...
                <th>video_id</th>
                <th>earnings</th>
                <th style="max-width: 200px; word-wrap:break-word">content_owner</th>
                <th>Label</th>
...
$(document).ready(function() {
    ...
    var table = $('#example').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": "../../controller/validate/youtube_ecommerce_paidv2.php",
            "data": function(d) {
                return $.extend({}, d, {
                    "search_keywords": $("#searchInput").val().toLowerCase(),
                    "filter_option": $("#sortBy").val().toLowerCase(),
                    "report": 'youtube_ecommerce_paid_features_report',
                    "reportMonthYear": '<?php echo $_GET["reportMonthYear"]?>',
                    "nd": '<?php echo $_GET["nd"]?>'
                });
            }
