    ...
    <div class="header" id="youtube1">
        ...
        <div class="row">
            ...
            <div class="col-lg-5">
                ...
                <h4 class="modal2-title">Validate Report    Music <?php echo $nd?> <?php echo $selectedDate?></h4>
                ...
                <fieldset id="div2" class="alert alert-danger">
                    <div>
                        ...
                        <form method="post" name="frmassigncontentowner" id="frmassigncontentowner"
                            ...
                            <div>
                            * Update will be on the basis of  (Saavan : Label)  </br>
    ...
    <table id="example" class="table table-striped table-hover" style="width:100%">
        <thead>
            <tr>
                ...
                <th>ISRC</th>
                <th>Label</th>
                <th>Ad-Supported Streams</th>
                <th>Ad-Supported Revenue </th>
                <th>Subscription Streams</th>
...
$(document).ready(function() {
    ...
    var table = $('#example').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": "../../controller/validate/saavanv2.php",
            "data": function(d) {
                return $.extend({}, d, {
