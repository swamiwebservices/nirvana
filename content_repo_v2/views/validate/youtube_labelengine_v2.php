...
if (!noError($conn)) {
  ...
  $type = "youtube_labelengine_report";
    ...
    <div class="header" id="youtube1">
        ...
        <div class="row">
            ...
            <div class="col-lg-11">
                ...
                <h4 class="modal2-title">Validate  Youtube US Report <?php echo $nd?>  <?php echo $selectedDate?></h4>
...
$(document).ready(function() {
    ...
    var table = $('#example').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": "../../controller/validate/youtube_labelenginev2.php",
            "data": function(d) {
                return $.extend({}, d, {
                    "search_keywords": $("#searchInput").val().toLowerCase(),
                    "filter_option": $("#sortBy").val().toLowerCase(),
                    "report": 'youtube_labelengine_report',
                    "reportMonthYear": '<?php echo $_GET["reportMonthYear"]?>',
                    "nd": '<?php echo $_GET["nd"]?>'
                });
            }
