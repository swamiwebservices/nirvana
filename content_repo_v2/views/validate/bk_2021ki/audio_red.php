...
<?php /*
    ...
    <div class="header" id="youtube1">
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <h4 class="modal2-title">Validate   Youtube Audio Finance</h4>
    ...
    <div class="col-md-12">
        ...
        <div class="" style="margin-left:1vw;">
            ...
            <select name="userName" id="contentowner" class="form-control1 selectpicker" data-live-search="true">
                ...
                <a class="btn btn-success" id="savebulk" data-toggle="collapse" href="#collapseExample5" role="button"
                    aria-expanded="false" aria-controls="collapseExample" style="margin-left:0.5vw;">Bulk Assign</a>
            ...
            <div class="modal-content">        
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-danger" id="deleteDistributorBtn" 
...
$(document).ready(function() {
    ...
    var table = $('#example').DataTable({
       ...
       // "searching": false,
        ...
        'initComplete':function( settings, json ) { console.log('rest');
  ...
  // table.draw();
    ...
    $(document).on('change', '.cselect', function() {
     ...
     function saveContentowner(ids,contentowner){  console.log(ids);
      if(!ids){
        alert('Please select records..'); return false;
      }
      $.ajax({
                type: "POST",
                dataType: "json",
                ...
                data: {
                    ...
                    reportMonthYear : '<?php echo $_GET["reportMonthYear"]?>',
                    report : 'youtube_audio_finance_report'
                },
