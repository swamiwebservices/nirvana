    ...
    <div class="header" id="youtube1">
        ...
        <div class="row">
            ...
            <div class="col-lg-11">
                ...
                <h4 class="modal2-title">Validate Report Youtube Music Report v2 <?php echo $nd ?></h4>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="alert alert-danger" style="">
                <span>Systems show #<?php echo $checkUnAssignedContentOwner ?> content owner is Not assigned <a
                        class="btn btn-success" id="btnExportunAssigned" data-toggle="collapse" href="#"
...
$(document).ready(function() {
    ...
    var table = $('#example').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": "../../controller/validate/youtube_redmusic_v2.php",
            "data": function(d) {
                return $.extend({}, d, {
                    "search_keywords": $("#searchInput").val().toLowerCase(),
                    "filter_option": $("#sortBy").val().toLowerCase(),
                    "report": 'youtube_video_claim_report_nd',
                    "reportMonthYear": '<?php echo $_GET["reportMonthYear"] ?>',
                    "nd": '<?php echo $_GET["nd"] ?>'
                });
            }
    ...
    function saveContentowner(ids, contentowner) {
        ...
        $.ajax({
            ...
            data: {
                ...
                reportMonthYear: '<?php echo $_GET["reportMonthYear"] ?>',
                report: 'youtuberedmusic_video_report'
            },
            success: function(response) {
                table.ajax.reload();
                //handle error in response
