    ...
    <div class="header" id="youtube1">
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <h4 class="modal2-title">Validate Report   Apple Music <?php echo $nd?></h4>
                ...
                <fieldset id="div2" class="alert alert-danger">
                    <div>
                        ...
                        <form method="post" name="frmassigncontentowner" id="frmassigncontentowner"
                            ...
                            <div>
                            * Update will be on the basis of   (  Apple  : Label)  </br>
...
$(document).ready(function() {
    ...
    var table = $('#example').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": "../../controller/validate/applemusicv2.php",
            "data": function(d) {
                return $.extend({}, d, {
