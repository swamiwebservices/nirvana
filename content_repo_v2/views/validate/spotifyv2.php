    ...
    <div class="header" id="youtube1">
        ...
        <div class="row">
            ...
            <div class="col-lg-5">
                ...
                <h4 class="modal2-title">Validate Report  <?php echo $nd?>  Music   <?php echo $selectedDate?></h4>
                ...
                <fieldset id="div2" class="alert alert-danger">
                    <div>
                        ...
                        <form method="post" name="frmassigncontentowner" id="frmassigncontentowner"
                            ...
                            <div>
                            * Update will be on the basis of   (Spotify: Label) </br>
...
$(document).ready(function() {
    ...
    var table = $('#example').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": "../../controller/validate/spotifyv2.php",
            "data": function(d) {
                return $.extend({}, d, {
