...
<body>
    <div class="wrapper">
        <?php 
        $pageTitle = "Export Revenue Assets-id";
                                    ...
                                    <form class="form-inline" enctype="multipart/form-data" id="uploadReportForm"
                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-group ">
                                                            <select class="form-control" name="type_cate"
                                                                ...
                                                                <option value="youtube_video_claim_report_nd">Youtube
                                                                    Claim
                                                                    Report</option>
                                                                <option value="youtuberedmusic_video_report">Youtube
                                                                    Youtube
                                                                    Music</option>
                                                                ...
                                                                <option value="youtube_labelengine_report">Youtube US
                                                                    Report
                                                                </option>
                                        ...
                                        <div class="col-md-12">
                                            <div class="col-md-3" id="step4">
                                                <div class="form-group mx-sm-3 mb-2">
                                                    ...
                                                    <input type="radio" class="form-control" id="onlyunassigned2"
                                        ...
                                        <div class="col-md-12 form-group is-empty">
                                            Path for file download : /var/lib/mysql-files/forDJ/</br>
                                             ...
                                             For contentOwner: AssetCoMAPRevenue_nd1_2021-07_mobilemedia_1631606467.csv        
                                        </div>
...
?>
    ...
    function submitClient(buttonElement) {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo $rootUrl; ?>controller/export/index.php",
            data: {
                mode: $("#mode").val(),
                cmstype: $("#cmstype").val(),
    ...
    <div class="modal fade" id="confirmClientModal">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Export Revenue!</h4>
            </div>
