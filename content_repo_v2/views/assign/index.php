...
<body>
    <div class="wrapper">
        <?php 
        $pageTitle = "Assign Content Owner";
                                    ...
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">
                                            <a href="<?php echo $rootUrl."views/assign/"; ?>">
                                                <i class="fa fa-arrows">&nbsp;</i>Assign Content Owner
                                            </a>
                                        </li>
                                    </ol>
                                </div> <!-- end card header -->
                                ...
                                ?>
                                    ...
                                    <form class="form-inline" enctype="multipart/form-data" id="uploadReportForm"
                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-group ">
                                                            <select class="form-control" name="type_cate"
                                                                ...
                                                                <option value="youtube_video_claim_report_nd">Youtube Claim
                                                                    Report</option>
                                                                <option value="youtuberedmusic_video_report">Youtube Youtube
                                                                    Music</option>
                                                                <option value="youtube_red_music_video_finance_report">Youtube Red Finance
                                                                </option>
                                                                <option value="youtube_ecommerce_paid_features_report">Youtube
                                                                    ecommerce paid features</option>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-4" id="step4">
                                                ...
                                                ?>
                                                    ...
                                                    <select name="contentOwner" id="contentOwner"
                                                        class="form-control">
                                            ...
                                            <div class="col-md-2" id="step5">
                                                <div class="form-group mx-sm-3 mb-2">
                                                    <label for="content_type" class="sr-only">Content Type</label>
                                                    <select name="content_type" id="content_type" class="form-control">
                                                        <option value="">Content Type</option>
                                                        <option value="">Both</option>
                                                        <option value="Partner-provided">Partner-provided</option>
                                                        <option value="UGC">UGC</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-3" id="step6">
                                                <div class="form-group mx-sm-3 mb-2">
                                                    <label for="asset_id" class="sr-only">Asset-id</label>
                                                    <input type="text" class="form-control" id="asset_id"
                                                        name="asset_id" placeholder="Asset-id">
                                                </div>
                                            </div>

                                            <div class="col-md-3" id="step7">
                                                <div class="form-group mx-sm-3 mb-2">
                                                    <label for="channel_id" class="sr-only">Channel-id</label>
                                                    <input type="text" class="form-control" id="channel_id"
                                                        name="channel_id" placeholder="Channel-id">
                                                </div>
                                            </div>
                                            <div class="col-md-3" id="step8">
                                                <div class="form-group mx-sm-3 mb-2">
                                                    
                                                    <input type="checkbox" class="form-control" id="onlyunassigned"
                                                        name="onlyunassigned" value="1" > Only Un-assigned Content Owner 
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-12 form-group is-empty">
                                            <button class="btn" type="button" id="btnSumit">Assign Content Owner
                                            </button>
                                        </div>
                                </div>
...
?>
 ...
 <!--    <script src="<?php echo $rootUrl; ?>assets/js/material-dashboard.js"></script> -->
    ...
    $('#btnSumit').click(function() {
        ...
        if(asset_id=="" && channel_id==''){
            alert("Please enter either asset id or channel id ");
            return false;
        }
    ...
    function submitClient(buttonElement) {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo $rootUrl; ?>controller/assign/index.php",
            data: {
                mode: $("#mode").val(),
                cmstype: $("#cmstype").val(),
                ...
                onlyunassigned: $("#onlyunassigned").is(":checked") ? $("#onlyunassigned").val() : 0
            },
    ...
    <div class="modal fade" id="confirmClientModal">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Assign Content Owner!</h4>
            </div>
            <div class="modal-body">
                ...
                <p>
                    Are you sure you want to Assign Content Owner?
                <p id="dataSelected"></p>
                </p>
