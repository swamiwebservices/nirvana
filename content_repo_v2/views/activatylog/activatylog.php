...
)
{
	...
	$getDistributorInfoQuery = "SELECT {$fieldsStr} FROM activity_reports";
	if (!empty($whereClause))
 ...
 <!------------------------------------------------------------------------------------------------------------------------------------------>                                   
                                    ...
                                    <table class="table table-bordered table-condensed">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                            <tr>
                                            <td><?php echo $distributorDetails["login_user"]; ?></td>
                                                <td><?php echo $distributorDetails["table_name"]; ?></td>
                                                <td><?php echo $distributorDetails["file_name"]; ?></td>
                                                <td><?php echo $distributorDetails["status_name"]; ?></td>
                                                <td><?php echo $distributorDetails["status_flag"]; ?></td>
