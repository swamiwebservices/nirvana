    ...
    if (!noError($userInfo)) {
        ...
        if (empty($userInfo)) {
            ...
            if ($userInfo[$email]["status"]!=1) {
                ...
                $allClientsCount = getClientsInfoAmazon($clientSearchArr, $fieldsStr, $dateField, $conn);
                ...
                if (!noError($allClientsCount)) {
                    ...
                    $allClientsInfo = getClientsInfoAmazon(
                        $clientSearchArr,
                        $fieldsStr,
                        $dateField,
                        $conn,
...
<body>
                                ...
                                <div class="card-header">
                                    ...
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">
                                            <a href="<?php echo $rootUrl; ?>views/clients/clients_mapping_amazon.php">
                                                <i class="fa fa-users">&nbsp;</i>Clients Mapping With Amazon
                                            </a>
                                        </li>
                                    </ol>
                                </div> <!-- end card header -->
                                <div class="card-content">
                                    ...
                                    ?>
                                        <div class="col-md-12">
                                            ...
                                            >
                                                <span class="fa fa-plus">Add Client with Amazon</span>
                                            </a>
                                        </div>
                                    <?php
                                    }
                                    ...
                                    <table class="table table-bordered table-condensed">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $clientDetails["session_id"]; ?></td>
                                                <td><?php echo $clientDetails["title_name"]; ?></td>
                                                ...
                                                ?>
                                                    ...
                                                    <a href="javascript:;"
                                                        ...
                                                        <a class="btn btn-xs btn-danger" onclick="confirmDeleteClient('<?php echo htmlentities($clientDetails['client_username']); ?>','<?php echo htmlentities($clientDetails['session_id']); ?>');"> 
    ...
    ?>
        ...
        <div class="modal fade modal-lg" id="addClientModal">
            ...
            <div class="modal-content">        
                <div class="modal-header">
                    <h4 class="modal-title"><span></span> Client with Amazon</h4>
                </div>
                <div class="modal-body">
                    <div class="alert" style="display: none">
                        <span></span>
        ...
        <script>
            ...
            function deleteClient(buttonElement)
            {
                ...
                $.ajax({
                    type: "POST",
                    dataType: "json",
                    url: "<?php echo $rootUrl; ?>controller/client/delete/delete_amazon_mapping.php",
                    data: {"userName":encodeURIComponent(userName),"session_id":encodeURIComponent(session_id)},
            ...
            function showAddClientForm(userName, actionType)
            {
                ...
                $("#addClientModal .modal-body-content").load(
                    "<?php echo $rootUrl; ?>views/clients/manage/amazon_client_mapping.php?userName="+encodeURIComponent(userName)
                );
