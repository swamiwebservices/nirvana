           ...
           if (empty($userInfo)) {
               ...
               if ($userInfo[$email]["status"]!=1) {
                   ...
                   if (!noError($allClientsCount)) {
                       ...
                       $fieldsStr = "id,content_owner, total_amt_recd, shares, amt_payable ,us_payout,witholding,final_payable,status";
...
<body>
    ...
    <div class="header" id="youtube1">
        <div class="row">
            ...
            <div class="col-lg-3">
                <h4 class="modal2-title">Activate Report Youtube Audio Finance</h4>
            </div>
        </div>
    </div>
    ...
    $('#genrateReport').on('click', function(e) {
        $.ajax({
            ...
            data: {
                ...
                type: 'youtube_activation_audio_finance_report'
            },
    ...
    function saveContentowner(ids, status) {
        ...
        $.ajax({
            ...
            data: {
                ...
                report: 'youtube_activation_audio_report'
            },
            success: function(response) {
