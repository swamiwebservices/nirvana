           ...
           if (empty($userInfo)) {
               ...
               if ($userInfo[$email]["status"]!=1) {
                   ...
                   if (!noError($allClientsCount)) {
                       ...
                       $fieldsStr = "id,content_owner, total_amt_recd, witholding, amt_recd,shares, amt_payable ,witholding,final_payable,status";
...
<body>
    ...
    <div class="header" id="youtube1">
        <div class="row">
            ...
            <div class="col-lg-3">
                <h4 class="modal2-title">Activate Report Amazon Video</h4>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-12">
        <div class="card">
              ...
              <?php  
                 if(!$haveactivationreport || empty($allClientsInfo)){ ?>
    ...
    $('#genrateReport').on('click', function(e) {
        $.ajax({
            ...
            data: {
                ...
                type: 'amazon_video_activation_report'
            },
    ...
    function saveContentowner(ids, status) {
        ...
        $.ajax({
            ...
            data: {
                ...
                report: 'amazon_activation_report'
            },
            success: function(response) {
